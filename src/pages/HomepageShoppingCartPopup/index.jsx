...
import C04HomepageShoppingCartPopupShoppingcart from "components/C04HomepageShoppingCartPopupShoppingcart";
...
const HomepageShoppingCartPopupPage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-publicsans items-center justify-end mx-auto w-full">
        ...
        <div className="md:h-[1736px] h-[764px] md:px-5 relative w-full">
          ...
          <C04HomepageShoppingCartPopupShoppingcart
            className="absolute bg-white-A700 border border-gray-300 border-solid flex flex-col gap-5 items-center justify-center pb-6 right-[22%] rounded shadow-bs7 top-[16%] w-auto"
            shoppingcarttext={
              <Text className="font-medium text-base text-gray-900 w-auto">
                <span className="text-gray-900 font-publicsans text-left">
                  Shopping Cart{" "}
                </span>
...
export default HomepageShoppingCartPopupPage;
